...
img.img-sec2-4:hover {
    ...
    transition-duration: 2s, 3s, 2s, 3s;
        ...
        <body>
            ...
            <div class="row-seccion-analisis" >
                <div class="col-12-sec1">
                    <div class="container-fluid" style="width: 80%;">  
                        
                        <a href="" class="enlaceInico"><p class="textoEnlace">nombreProy</p></a>
                        <h3 class="text-titulo2"><p class="texto1analisis" style="    margin-top: 0;
                            margin-bottom: 1rem;
                            margin-left: -8%;">ANÁLISIS DE VIDEOJUEGOS </p><br> </h3>
                                                     
                    </div>
                    <br>
                    <br>
                    <h5 style="margin:10px 50px 0 50px">En esta página encontrarás todos los análisis de videojuegos que tenemos. ¿Estás pensando en comprar un videojuego? En esta web contamos con un equipo de analistas especializados para analizar los últimos lanzamientos valorando aspectos como los gráficos, el sonido, la jugabilidad, el rendimiento, los diferentes modos de juego y otros aspectos en su conjunto y le aplicamos una nota de 1 a 10, que representa su calidad general, para que te ayude a decidir qué juegos merecen la pena, cuáles cumplen las expectativas y cuáles se quedan atrás.</h5>
                </div>    
                <div class="container-fluid ">
                    <div class="col-12">
                        <div class="tarjeta">
                            <div class="cuerpo"> 
                            <img src="https://media.vandal.net/i/300x160/8-2022/20228101316025_1.jpg"  class="img-sec2-1" style="width: 15%;border-radius: 10px;" alt="muestra"><h4 class="textimg-sec2">Spider-Man: Remastered</h4>              
                            </div>
